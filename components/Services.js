...
const Services = (props) => {
  ...
  return (
    <section className="px-12 pb-12 2xl:px-0 about md:flex items-start services">
      <div className="container mx-auto">
        ...
        <div className="mb-12 md:mb-0 services__img opacity-0 shift-down">
          ...
          <div className="services__content md:w-1/2 text-xl xl:text-3xl md:pl-8 2xl:pl-0 md:text-2xl opacity-0 shift-down">
